...
const HeroSection = () => {
  return (
    <div className=" h-screen bg-slate-500 items-center w-full  sm:flex sm:justify-between sm:items-center border-b-2 border-gray-300 ">
      <div className=" flex-col sm:w-2/3 ">
        <h2
          className="  flex-auto sm:p-0  pt-6 text-center text-4xl   sm:text-left md:text-5xl 
